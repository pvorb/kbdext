...
; Reihe 2
EDS("010",1,"q","Q","…","S__PgUp","ξ","Ξ") ; x
EDS("011",1,"w","W","_","U000008","" ,"√") ; v
EDS("012",1,"e","E","[","S____Up","λ","Λ") ; l
EDS("013",1,"r","R","]","S___Del","χ","ℂ") ; c
EDS("014",1,"t","T","^","S__PgDn","ω","Ω") ; w
EDS("015",1,"z","Z","!","¡"      ,"κ","×") ; k
EDS("016",1,"u","U","<","S__N__7","ψ","Ψ") ; h
EDS("017",1,"i","I",">","S__N__8","γ","Γ") ; g
EDS("018",1,"o","O","=","S__N__9","φ","Φ") ; f
EDS("019",1,"p","P","&","S__NAdd","ϕ","ℚ") ; q
EDS("01A",1,"ü","Ü","ſ","−"      ,"ς","∘") ; ß
EDS("01B",0,"T__acut","T__tlde","T__strk","T__dbac","T_psili","T__brve") ; acute
; Reihe 3
EDS("01E",1,"a","A","\","S__Home","" ,"⊂") ; u
EDS("01F",1,"s","S","/","S__Left","ι","∫") ; i
EDS("020",1,"d","D","{","S__Down","α","∀") ; a
EDS("021",1,"f","F","}","S__Rght","ε","∃") ; e
EDS("022",1,"g","G","*","S___End","ο","∈") ; o
EDS("023",1,"h","H","?","¿"      ,"σ","Σ") ; s
EDS("024",1,"j","J","(","S__N__4","ν","ℕ") ; n
EDS("025",1,"k","K",")","S__N__5","ρ","ℝ") ; r
EDS("026",1,"l","L","-","S__N__6","τ","∂") ; t
EDS("027",1,"ö","Ö",":","S__NDot","δ","Δ") ; d
EDS("028",1,"ä","Ä","@","."      ,"υ","∇") ; y
; Reihe 4
EDS("02C",1,"y","Y","#","U00001B","" ,"∪") ; ü
EDS("02D",1,"x","X","$","U000009","ϵ","∩") ; ö
EDS("02E",1,"c","C","|","S___Ins","η","ℵ") ; ä
EDS("02F",1,"v","V","~","U00000D","π","Π") ; p
EDS("030",1,"b","B","``",""      ,"ζ","ℤ") ; z
EDS("031",1,"n","N","+",":"      ,"β","⇐") ; b
