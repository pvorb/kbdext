...
thekeys() {
;   KeyCode Ebene 1 Ebene 3       Ebene5
;               Ebene 2 Ebene 4       Ebene 6
; Reihe 1
EDS("029",0,"T__cflx","°","T__turn","T__abdt","T__hook","T__bldt") ; circumflex
EDS("002",0,"1","!","","¹"      ,"","") ; 1
EDS("003",0,"2","""","","²"     ,"","") ; 2
EDS("004",0,"3","§","","³"      ,"","") ; 3
EDS("005",0,"4","$","","⋮"      ,"","") ; 4
...
EDS("00B",0,"0","=","","}"      ,"","") ; 0
EDS("00C",0,"ß","?","" ,"\"      ,"","") ; -
EDS("00D",0,"T__acut","T__grav","","","","") ; grave
; Reihe 2
EDS("010",1,"q","Q","…","S__PgUp","","") ; x
EDS("011",1,"w","W","_","U000008","","") ; v
EDS("012",1,"e","E","[","S____Up","","") ; l
EDS("013",1,"r","R","]","S___Del","","") ; c
EDS("014",1,"t","T","^","S__PgDn","","") ; w
EDS("015",1,"z","Z","!","¡"      ,"","") ; k
EDS("016",1,"u","U","<","S__N__7","","") ; h
EDS("017",1,"i","I",">","S__N__8","","") ; g
EDS("018",1,"o","O","=","S__N__9","","") ; f
EDS("019",1,"p","P","&","S__NAdd","","") ; q
EDS("01A",1,"ü","Ü","","−"      ,"","") ; ß
EDS("01B",0,"+","*","","~","","") ; acute
; Reihe 3
EDS("01E",1,"a","A","\","S__Home","","") ; u
EDS("01F",1,"s","S","/","S__Left","","") ; i
EDS("020",1,"d","D","{","S__Down","","") ; a
EDS("021",1,"f","F","}","S__Rght","","") ; e
EDS("022",1,"g","G","*","S___End","","") ; o
EDS("023",1,"h","H","?","¿"      ,"","") ; s
EDS("024",1,"j","J","(","S__N__4","","") ; n
EDS("025",1,"k","K",")","S__N__5","","") ; r
EDS("026",1,"l","L","-","S__N__6","","") ; t
EDS("027",1,"ö","Ö",":","S__NDot","","") ; d
EDS("028",1,"ä","Ä","@","."      ,"","") ; y
; Reihe 4
EDS("02C",1,"y","Y","#","U00001B","","") ; ü
EDS("02D",1,"x","X","$","U000009","","∩") ; ö
EDS("02E",1,"c","C","|","S___Ins","","ℵ") ; ä
EDS("02F",1,"v","V","~","U00000D","","Π") ; p
EDS("030",1,"b","B","``",""      ,"","ℤ") ; z
EDS("031",1,"n","N","+",":"      ,"","⇐") ; b
EDS("032",1,"m","M","%","S__N__1","","⇔") ; m
EDS("033",0,",",";","""","S__N__2","","⇒") ; ,
EDS("034",0,".",":","'","S__N__3","","↦") ; .
EDS("035",1,"-","_",";",""      ,"","Θ") ; j
...
EDNS("049",0,"S__N__9","†","" ,"S__NPUp","S_SNPUp","≫","⌉") ; Numpad9
